  ...
  return (
    <section id="hero" className="relative pt-28 pb-16 sm:pt-36 sm:pb-24 border-b border-zinc-900/80">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        {/* Centered Modern Animated Profile Picture */}
        <div className="relative group mb-8">
          ...
          <div className="relative p-[3px] rounded-full bg-gradient-to-tr from-zinc-700 via-indigo-500/70 to-zinc-600 shadow-2xl">
            {/* Full Centered Circular Portrait */}
            <div className="w-52 h-52 sm:w-64 sm:h-64 md:w-72 md:h-72 rounded-full overflow-hidden bg-zinc-950 shadow-2xl relative">
              <img
                src="/profile.jpg"
                alt="Abdul Rafay"
          ...
          {/* Centered Floating Tech Micro-Badges */}
          <div className="absolute -bottom-2 -left-2 sm:-left-4 bg-zinc-950/90 border border-zinc-800 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-lg flex items-center gap-1.5 text-xs font-mono text-zinc-200">
            <Code2 className="w-3.5 h-3.5 text-indigo-400" />
            <span>Backend // AI</span>
          </div>

          <div className="absolute -top-1 -right-2 sm:-right-4 bg-zinc-950/90 border border-zinc-800 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-lg flex items-center gap-1.5 text-xs font-mono text-emerald-400">
        ...
        {/* Status Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-zinc-900/90 border border-zinc-800 text-xs font-mono font-medium text-zinc-300 mb-6 shadow-sm">
          <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
          <span className="uppercase tracking-wider">Available for Internships &amp; Projects</span>
        </div>

        {/* Main Headline - Centered Bold Geometric Font */}
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.1] font-['Montserrat',sans-serif] max-w-4xl">
          CS Student · Aspiring Full-Stack Developer
        </h1>

        {/* Subtitle - Centered Exact: Backend & AI Assisted Workflows */}
        <h2 className="mt-4 text-xl sm:text-2xl font-bold text-indigo-300 font-mono tracking-tight">
          Backend &amp; AI Assisted Workflows
        </h2>

        {/* Description - Centered Clean Inter Typography */}
        ...
        {/* Sharp Geometric Telemetry HUD - Centered */}
        <div className="mt-12 pt-8 border-t border-zinc-900/90 w-full max-w-3xl grid grid-cols-2 sm:grid-cols-4 gap-4 text-left">
